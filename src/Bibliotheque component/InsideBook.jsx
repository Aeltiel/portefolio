          ...
          {isUnOpen ? (
            <div className="inside__Container">
              <button
                className="closeBtn"
                onClick={() => {
                  dispatch(UnOpen(false));
                  dispatch(setDragonsKey(null));
                }}
              >
                <i className="fa-solid fa-xmark"></i>
              </button>
              <div className="inside__page">{content}</div>
            </div>
          ) : (
            <div></div>
          )}
