            ...
            <>
                ...
                <main className="projectConatainer" key={data.id}>
                    ...
                    <div className="project__cta">
                            <p>Bien ! À présent que vous avez une idée de ce que je sais faire, je vous propose d'en savoir un peu plus sur moi !</p>
                            <Link to='/About'><Button name={"Découvrir"}/></Link>
                    </div>
                </main>
                <Footer />
            </>
