      ...
      <main className="homeContainer">
        ...
        <div className="presentation">
          ...
          <h2 className="presentation__title">
            Ingrid STEMER <br /> Conceptrice Développeuse d'Application en
            Alternance/ <br /> Developpeuse Web Junior
          </h2>
        </div>
        ...
        <div className="home__info">
          <div className="home__info__text">
            <p className="home__info__text--text">
              Avant de continuer, j'aimerais vous donner quelques précisions sur
              le fonctionnement de ce portefolio. En effet, l'onglet
              Bibliothèque vous transportera dans une version alternative de mon
              portefolio, je vous laisse, bien sur, le soin de le découvrir par
              vous-même. Le reste du portefolio est construit de manière tout à
              fait classique.
            </p>
        ...
        <div className="home__project">
          ...
          <div className="home__project__container">
            ...
            <p className=" home__project--text">
              Vous souhaitez voir de quoi je suis capable ? Regardez mes projets
              !
            </p>
