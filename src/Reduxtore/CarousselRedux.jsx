...
export const CarousselSlice = createSlice({
    ...
    initialState : {
        ...
        carousselData : [{
            id :"1",
            title: "Booki",
            image : "http://localhost:5500/src/Assets/Booki-screen.webp",
        ...
        },
        {
            id:"2",
            title: "Oh My Food",
            image : "http://localhost:5500/src/Assets/OhMyFood-screen.webp",
        ...
        },
        {
            id:"3",
            title: "La Panthère",
            image : "http://localhost:5500/src/Assets/LaPanthere-screen.webp",
        ...
        },
        {
            id:"4",
            title: "Kanap",
            image : "http://localhost:5500/src/Assets/Kanap-screen.webp", 
        ...
        },
        {
            id :"5",
            title: "Piiquante",
            image : "http://localhost:5500/src/Assets/Piiquante-screen.webp",
        ...
        },
        {
            id:"6",
            title: "Kasa",
            image : "http://localhost:5500/src/Assets/Kasa-screen.webp",
        ...
        },
        {
            id:"7",
            title: "Portefolio",
            image : "http://localhost:5500/src/Assets/Corbeau-sur-crâne-01.webp",
    ...
    reducers : {
        prochainCaroussel : (state, action) => {
            var tailleTableau  = state.carousselData.length;
            if (state.carousselIndex < tailleTableau - 1) {
                state.carousselIndex = state.carousselIndex + 1;
            }
            else {
                state.carousselIndex = 0;
            }
        },
        precedentCaroussel : (state, action) => {
            var tailleTableau  = state.carousselData.length;
            if (state.carousselIndex > 0){
                state.carousselIndex -= 1;
            }
            else {
                state.carousselIndex = tailleTableau - 1;
            }
        }
    }
})
